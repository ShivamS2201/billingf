...
msg.Br.length+ " Branch " )
  ...
  return (
    <>
          ...
          <Form style={{ margin: "7vw 7vw 2vw 7vw" }}>
            <Container fluid>
              ...
              <Row style={{marginTop:"5vh"}}>
                <Col xs={{offset:"9"}} >
                <Button style={{margin:" 0 -6vw 0 1vw"}} onClick={SendMsg}> Send Message</Button> 
                </Col>
              </Row>
            </Container>
          </Form>
      ...
      {currentRoute.pathname.toLowerCase().includes("whatsapp") && <>WA HERE</>}
      {currentRoute.pathname.toLowerCase().includes("email") && <>Em HERE</>}
      {currentRoute.pathname.toLowerCase().includes("mos") && <>MOS HERE</>}
{JSON.stringify(msg)}
      <FooterC />
    </>
  );
